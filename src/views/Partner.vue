        ...
        <div class="col">
          <div class="card shadow">
                ...
                >
                  <template #cell(actions)="data">
                    ...
                    >
                      ...
                      <b-form class="ml-2">
                        <b-button
                          v-b-modal="`modalUpdatePartner${data.item.id}`"
            ...
            <div v-for="(partner, index) in partners" :key="partner.id">
                <b-modal
                  :id="`modalUpdatePartner${partner.id}`"
                  title="Modifica Prodotto"
                  hide-footer
                  v-model="showModal2[index]"
                >
                  <b-form ref="form" @submit.prevent="submitUpdate(partner.id, index)">
                    <b-form-group
...
export default {
  ...
  mounted() {
    axios.get("http://api-gateway.smartcity-uniupo.link/api/user/partner").then((response) => {
